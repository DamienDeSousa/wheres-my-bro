...
export const Presentation: React.FC = () => {
  ...
  return (
    <div className="flex flex-col items-center gap-14 p-2">
      <h2 className="text-center">Trouvez un BRO en quelques clics et commencez une activité sportive</h2>
      <div className="flex flex-col items-center gap-5">
        <Card
          title="Peur de faire un développé couché seul ?"
          content="Ce temps est révolu car votre BRO sera là pour vous parer."
        />
        <Card
        ...
        <Card
          ...
          content="Grâce à votre BRO, vous ne perdrez plus de vue vos objectifs."
        />
      </div>
